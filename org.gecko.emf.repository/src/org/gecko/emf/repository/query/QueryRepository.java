...
public interface QueryRepository {
	...
	/**
	 * Checks whether an {@link EObject} of the given {@link EClass} and the provided id exists or not
	 * @param eClass the {@link EClass} of the object to check
	 * @param id the id value of the object to check
	 * @return <code>true<code> if the object is found, <code>false>code> otherwise
	 */
