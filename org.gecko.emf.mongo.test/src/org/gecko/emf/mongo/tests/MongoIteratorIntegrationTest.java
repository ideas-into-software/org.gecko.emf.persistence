...
//import org.gecko.emf.mongo.annotations.RequireMongoEMFIteratorExtension;
...
//@RequireMongoEMFIteratorExtension
...
//		
//		filter = "(" + ComponentConstants.COMPONENT_NAME + "=EIteratorInputContentHandler)";
...
//		assertTrue(findResource.getContents().get(0) instanceof Iterable);
//		
//		EIterable resultIterable = (EIterable) findResource.getContents().get(0);
//		Iterator<EObject> eoIterator = resultIterable.iterator();
//		Iterator<EObject> eoIterator2 = resultIterable.iterator();
//		assertNotEquals(eoIterator, eoIterator2);
//		
//		/*
...
//		eoIterator.forEachRemaining((eo)->{
