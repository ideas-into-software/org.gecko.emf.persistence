...
public class ServicesUtil {
    ...
    public void registerProviderService() {
        ...
        // Service strings
        String[] serviceNames = { jakarta.persistence.spi.PersistenceProvider.class.getName() };
        // Get a provider JPA SPI instance 
        jakarta.persistence.spi.PersistenceProvider persistenceProvider = mgr.getProvider();
    ...
    public void tryToRegisterEMFService(PUnitInfo pUnitInfo,
        ...
        // Load the EMF class
        Class<?> emfClass = GeminiUtil.loadClassFromBundle("jakarta.persistence.EntityManagerFactory",
                                                           mgr.getBundle());
