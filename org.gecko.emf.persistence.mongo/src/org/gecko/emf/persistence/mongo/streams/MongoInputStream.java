...
public class MongoInputStream extends InputStream implements URIConverter.Loadable {
	...
	private QueryEngine<EMongoQuery> queryEngine;
	private MongoCollection<Document> collection;
	private List<InputContentHandler<FindIterable<EObject>>> contentHandler;
	private Map<Object, Object> response;

	public MongoInputStream(ConverterService converterService, QueryEngine<EMongoQuery>  queryEngine, MongoCollection<Document> collection, List<InputContentHandler<FindIterable<EObject>>> contentHandler, URI uri, Map<?, ?> options, Map<Object, Object> response) throws IOException {
	...
	public void loadResource(Resource resource) throws IOException {
		...
		Optional<InputContentHandler<FindIterable<EObject>>> handlerOptional = contentHandler.stream()
