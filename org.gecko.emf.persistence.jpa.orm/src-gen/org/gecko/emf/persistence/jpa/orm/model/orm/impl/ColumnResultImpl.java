 ...
 * </p>
 * <ul>
 *   <li>{@link org.gecko.emf.persistence.jpa.orm.model.orm.impl.ColumnResultImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link org.gecko.emf.persistence.jpa.orm.model.orm.impl.ColumnResultImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnResultImpl extends MinimalEObjectImpl.Container implements ColumnResult {
	...
	protected EClass eStaticClass() {
		return OrmPackage.eINSTANCE.getColumnResult();
	}
	...
	public void setClass(String newClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrmPackage.COLUMN_RESULT__CLASS, oldClass, class_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrmPackage.COLUMN_RESULT__CLASS:
				return getClass_();
