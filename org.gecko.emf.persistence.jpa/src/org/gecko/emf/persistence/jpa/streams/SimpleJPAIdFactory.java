 ...
 * @since 15.01.2023
 */
@Component(name="JPAIdFactory", immediate=true, scope = ServiceScope.SINGLETON, property = PERSISTENCE_FILTER_PROP)
public class SimpleJPAIdFactory implements PrimaryKeyFactory{
