    ...
    stages {
        stage('Main branch release') {
            ...
            steps {
                ...
                sh "./gradlew clean build itest release -Drelease.dir=$JENKINS_HOME/repo.gecko/release/org.gecko.emf.persistence --info --stacktrace -Dmaven.repo.local=${WORKSPACE}/.m2"
            }
        }
