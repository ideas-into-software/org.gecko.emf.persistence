...
//
//import static org.gecko.emf.persistence.config.PersistenceConfiguratorConstants.EMF_PERSISTENCE_CONFIGURATION_NAME;
...
//
///**
// * Configuration component that brings up a EMF persistence setup
// * @author Mark Hoffmann
// * @since 20.02.2023
// */
//@Component(name = EMF_PERSISTENCE_CONFIGURATION_NAME, immediate = true, configurationPolicy = ConfigurationPolicy.REQUIRE)
//@RequireConfigurationAdmin
//public class EMFPersistenceConfigurator {
//
//	private static final Logger logger = Logger.getLogger(EMFPersistenceConfigurator.class.getName());
...
//		String instances = (String) properties.get(PersistenceConfiguratorConstants.PROP_INSTANCES);
//		Set<InstanceConfiguration> instanceConfigs = null;
//		if (instances != null && !instances.isEmpty() && !instances.isBlank()) {
//			instanceConfigs = createInstanceConfiguration(instances.split(","), properties);
//		} else {
...
//		}
//		instanceConfigs.forEach(c -> setupRepositoryConfiguration(c));
//	}
//
//	/**
...
//			mongoConfigs = createInstanceConfiguration(instances.split(","), properties);
//		} else {
//			throw new ConfigurationException(MONGO_INSTANCE_PROP,
...
//	 */
//	private Set<InstanceConfiguration> createInstanceConfiguration(String[] instances, Map<String, Object> properties) {
//		if (Objects.isNull(instances) || Objects.isNull(properties)) {
...
//				if (properties.containsKey(instancePrefix + PROP_REPOSITORY_TYPE)) {
//					config.setRepositoryType(RepositoryType
//							.valueOf(((String) properties.get(instancePrefix + PROP_REPOSITORY_TYPE)).toUpperCase()));
//				}
//				String authSource = (String) properties.get(instancePrefix + PROP_AUTH_SOURCE);
//				String user = (String) properties.get(instancePrefix + PROP_USER);
//				String pwd = (String) properties.get(instancePrefix + PROP_PASSWORD);
//				String connectionUris = (String) properties.get(instancePrefix + PROP_CONNECTION_URIS);
//				String databases = (String) properties.get(instancePrefix + PersistenceConfiguratorConstants.PROP_DATABASES);
...
//					dbConfiguration.setName(database.trim());
...
//						dbConfiguration.setType(RepositoryType.valueOf(
//								((String) properties.get(instance + "." + database + "." + MONGO_REPOSITORY_TYPE))
//										.toUpperCase()));
//					} else {
//						dbConfiguration.setType(config.getType());
//					}
//					config.getDatabaseConfigs().add(dbConfiguration);
//				}
...
//					if (c.getType() == RepositoryType.SINGLETON) {
