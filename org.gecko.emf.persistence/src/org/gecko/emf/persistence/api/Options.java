...
public interface Options {
	 ...
	 * {@link Resource} as response option with Key {@link #READ_COUNT_RESPONSE}.
	 * 
	 * To get the response options you have to set {@link URIConverter#OPTION_RESPONSE} with a new map
	 * to the load options
	 * 
	 * value type: Boolean, default is <code>false</code>
	 * @deprecated The {@link Countable#count(Map)} function can be used instead
	 */
	String READ_COUNT_RESULT = "COUNT_RESULT";
	 ...
	 * 
	 * <code>
	 * resourceSet.getLoadOptions().put(Options.OPTION_TYPE_ECLASS_URI, "_type");
	 * </code>
	 * 
	 * Value type: {@link String}
	 */
	String OPTION_FIELD_ECLASS_URI = "KEY_ECLASS_URI";
	 ...
	 * 
	 * <code>
	 * resourceSet.getLoadOptions().put(Options.OPTION_FIELD_SUPERTYPES, "_mySuperType");
	 * resourceSet.getSaveOptions().put(Options.OPTION_KEY_SUPERTYPES, "_mySuperType");
	 * </code>
	 * 
	 * Value type: {@link String}
	 */
	String OPTION_FIELD_SUPERTYPES = "KEY_SUPERTYPES";
	 ...
	 * Value type: {@link String}
	 */
	String OPTION_FIELD_PROXY_URI = "KEY_PROXY_URI";
	...
	/**
	 * Returns the proxy key, if the {@link Options#OPTION_FIELD_PROXY_URI}
	...
	public static String getProxyUriKey(Map<?, ?> options) {
		...
		Object result = options.get(OPTION_FIELD_PROXY_URI);
		return result == null ? Keywords.PROXY_KEY : result.toString();
	}
	
	/**
	 * Returns the EClass key, if the {@link Options#OPTION_FIELD_ECLASS_URI}
	...
	public static String getEClassKey(Map<?, ?> options) {
		...
		Object result = options.get(OPTION_FIELD_ECLASS_URI);
		return result == null ? Keywords.ECLASS_KEY : result.toString();
	}
	
	/**
	 * Returns the field key, if the {@link Options#OPTION_FIELD_SUPERTYPES}
	...
	public static String getSuperType(Map<?, ?> options) {
		...
		Object result = options.get(OPTION_FIELD_SUPERTYPES);
